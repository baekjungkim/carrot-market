    ...
    <div className="space-y-8 px-4 py-16">
      {[1, 2, 3, 4, 5, 6].map((_, i) => (
        <div key={i} className="flex flex-col items-start">
          <span className="ml-4 flex cursor-pointer items-center rounded-full bg-gray-100 px-2.5 py-0.5 text-xs font-medium text-gray-800 ">
            동네질문
          </span>
          ...
          <div className="mt-5 flex w-full items-center justify-between text-xs text-gray-500">
            <span>니꼬</span>
            <span>18시간 전</span>
          </div>
